...
public class PlantPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Zone zone12 = createZone("Zone 4A");
		Zone zone13 = createZone("Zone 4B");
		...
		plantRepo.save(
				new Plant("Beets", "Plant 1/2 inch deep in area with atleast partial sunlight.", "/images/beets.jpg",
						zone1, zone2, zone3, zone4, zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13));
		plantRepo.save(
				new Plant("Broccoli", "Plant 2-4 inches deep in an area with full sunlight.", "/images/broccoli.jpg",
						zone1, zone2, zone3, zone4, zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13));
		...
		plantRepo.save(new Plant("Celery",
				...
				"/images/celery.jpg", zone5, zone10, zone11, zone12, zone13));
		...
		plantRepo.save(
				new Plant("Corn", "Plant 1 inch deep, 4-6 inches apart.  Needs full sun view.", "/images/corn.jpg",
						zone1, zone2, zone3, zone4, zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13));
		plantRepo.save(
				new Plant("Cucumber", "Plant 6-8 inches into the soil.  Needs full sun view.", "/images/cucumber.jpg",
						zone1, zone2, zone3, zone4, zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13));
		plantRepo.save(new Plant("Chard", "Plant 1 inch deep, 2 inches apart.  Needs full sun view.",
				"/images/chard.jpg", zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13));
		plantRepo.save(new Plant("Collard Greens", "Plant 1/2 inch deep, 8-12 inches apart.  Need full sunlight view",
				"/images/collard-greens.jpg", zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13));
		...
		plantRepo.save(new Plant("Leek", "Plant 6 inches deep, 10-12 inches apart.  Need full sunlight",
				"/images/leek.jpg", zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13));
		plantRepo.save(
				new Plant("Onions", "Plant 1 inch deep, 4-5 inches apart.  Needs full sun view.", "/images/onions.jpg",
						zone1, zone2, zone3, zone4, zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13));
		...
		plantRepo.save(new Plant("Spinach", "Plant to 1/2 inch deep.  Needs full sunlight.", "/images/spinach.jpg",
				zone1, zone2, zone3, zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13));
		...
		plantRepo.save(
				new Plant("Pumpkins", "Plant 1 inch deep, 6-8 feet apart.  Does really well on a hill facing the sun.",
						"/images/pumpkins.jpg", zone1, zone2, zone3, zone4, zone5, zone6, zone7, zone8, zone9, zone10,
						zone11, zone12, zone13));
		...
		plantRepo.save(new Plant("Strawberries",
				...
				"/images/strawberry.jpg", zone1, zone2, zone3, zone12, zone13));
