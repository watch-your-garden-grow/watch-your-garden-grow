...
public class PlantPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		plantRepo.save(new Plant("Celery",
				...
				"/images/celery.jpg", zone5, zone10, zone11, zone12, zone13, zone14, zone15, zone16));
		...
		plantRepo.save(new Plant("Cucumber", "Plant 6-8 inches into the soil.  Needs full sun view.",
				...
				zone12, zone13, zone14, zone15, zone16));
		plantRepo.save(
				new Plant("Chard", "Plant 1 inch deep, 2 inches apart.  Needs full sun view.", "/images/chard.jpg",
						zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13, zone14, zone15, zone16));
		...
		plantRepo.save(new Plant("Lettuce", "Plant 1/2 inch deep, 12-15 inches apart.  Needs partial sunlight.",
				...
				zone12, zone13, zone14, zone15, zone16));
		plantRepo.save(
				new Plant("Leek", "Plant 6 inches deep, 10-12 inches apart.  Need full sunlight", "/images/leek.jpg",
						zone5, zone6, zone7, zone8, zone9, zone10, zone11, zone12, zone13, zone14, zone15, zone16));
		...
		plantRepo.save(new Plant("Strawberries",
				...
				"/images/strawberry.jpg", zone1, zone2, zone3, zone12, zone13, zone14, zone15, zone16));
